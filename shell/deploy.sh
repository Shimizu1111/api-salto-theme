...
ssh ec2-user@13.115.122.171 git -C ./api-salto-theme/ stash -u 
ssh ec2-user@13.115.122.171 git -C ./api-salto-theme/ pull origin master
ssh ec2-user@13.115.122.171 git -C ./api-salto-theme/ stash apply stash@{0}
# ファイル転送(ローカルからリモート)
